data:extend({
    {
        ...
        icons = util.technology_icon_constant_planet("__tenebris__/graphics/icons/technology/tenebris.png"),
        icon_size = 256,
        essential = true,
        effects =
        {
    ...
    },
    {
        type = "technology",
        name = "quartz-crystal",
        icon = "__tenebris__/graphics/icons/quartz-crystal.png",
        essential = true,
        effects =
        {
            {
    ...
    },
    {
        ...
        icon = "__tenebris__/graphics/icons/lucifunnel.png",
        essential = true,
        effects =
        {
            {
    ...
    },
    {
        ...
        icon = "__tenebris__/graphics/icons/tenecap.png",
        essential = true,
        effects =
        {
            {
    ...
    },
    {
        ...
        icon = "__tenebris__/graphics/icons/bioluminescent-crystal.png",
        essential = true,
        effects =
        {
            {
    ...
    },
    {
        ...
        icon = "__tenebris__/graphics/icons/chitin.png",
        essential = true,
        effects =
        {
            {
    ...
    },
    {
        type = "technology",
        name = "bioinfusor",
        icon = "__tenebris__/graphics/technology/bioinfusor.png",
        icon_size = 256,
        essential = true,
        effects =
        {
    ...
    },
    {
        ...
        icon = "__tenebris__/graphics/technology/navigation-upgrade.png",
        icon_size = 256,
        essential = true,
        effects =
        {
    ...
    },
    {
        type = "technology",
        name = "biobeacon",
        icon = "__tenebris__/graphics/technology/biobeacon.png",
        icon_size = 256,
        essential = true,
        effects =   
        {
