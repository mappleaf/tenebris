...
local function quick_item(name, stack_size, weight, glow, extra)
    return meld({
        ...
        icon = "__tenebris__/graphics/icons/" .. name .. ".png",
        pictures = {
            size = 64,
            filename = "__tenebris__/graphics/icons/" .. name .. ".png",
            scale = 0.5,
...
local bioluminescent_science_pack = meld(
    table.deepcopy(data.raw["tool"]["automation-science-pack"]), {
        ...
        icon = "__tenebris__/graphics/icons/bioluminescent-science-pack.png",
        order = "k[bioluminescent_science_pack]",
        pictures = meld.overwrite {
            scale = 0.5,
            size = 64,
            filename = "__tenebris__/graphics/icons/bioluminescent-science-pack.png",
            draw_as_glow = true,
        }
    })
...
data:extend({
    {
        ...
        icon = "__tenebris__/graphics/icons/luciferin.png",
        stack_size = 100,
        ...
        pictures = {
            ...
            width = 64,
            height = 64,
            filename = "__tenebris__/graphics/icons/luciferin.png",
            draw_as_glow = true,
        }
    },
    {
        ...
        icon = "__tenebris__/graphics/icons/lucifunnel-seed.png",
        pictures = {
            size = 64,
            filename = "__tenebris__/graphics/icons/lucifunnel-seed.png",
            scale = 0.5,
            mipmap_count = 4,
            draw_as_glow = true
        },
    ...
    },
    {
        ...
        icon = "__tenebris__/graphics/icons/quartz-ore.png",
        pictures =
        {
            size = 64,
            filename = "__tenebris__/graphics/icons/quartz-ore.png",
            scale = 0.5,
            mipmap_count = 4,
        },
    ...
    },
    {
        ...
        icon = "__tenebris__/graphics/icons/tenecap-spore.png",
        pictures = {
            size = 64,
            filename = "__tenebris__/graphics/icons/tenecap-spore.png",
            scale = 0.5,
        },
        subgroup = "agriculture-processes",
        inventory_move_sound = item_sounds.wood_inventory_move,
