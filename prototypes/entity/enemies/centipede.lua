...
local centipede_corpse = {
    ...
    pictures = {
        filename = "__tenebris__/graphics/entity/centipede/centipede-corpse.png",
        width = 410,
        height = 337,
        scale = 0.3,
        draw_as_glow = true,
...
local function create_centipede(name, scale, length, health, speed, damage, min_spawn_distance)
            ...
            layers = {
                {
                    ...
                    stripes = {
                        {
                            filename = "__tenebris__/graphics/entity/centipede/centipede-head-1.png",
                            width_in_frames = 8,
                            height_in_frames = 16,
                        },
                        {
                            filename = "__tenebris__/graphics/entity/centipede/centipede-head-2.png",
                            width_in_frames = 8,
                            height_in_frames = 16,
                        },
                        {
                            filename = "__tenebris__/graphics/entity/centipede/centipede-head-3.png",
                            width_in_frames = 8,
                            height_in_frames = 16,
                        },
                        {
                            filename = "__tenebris__/graphics/entity/centipede/centipede-head-4.png",
                            width_in_frames = 8,
                            height_in_frames = 16,
                        },
                    }
                },
                {
                    ...
                    stripes = {
                        {
                            filename = "__tenebris__/graphics/entity/centipede/centipede-head-light-1.png",
                            width_in_frames = 8,
                            height_in_frames = 16,
                        },
                        {
                            filename = "__tenebris__/graphics/entity/centipede/centipede-head-light-2.png",
                            width_in_frames = 8,
                            height_in_frames = 16,
                        },
                        {
                            filename = "__tenebris__/graphics/entity/centipede/centipede-head-light-3.png",
                            width_in_frames = 8,
                            height_in_frames = 16,
                        },
                        {
                            filename = "__tenebris__/graphics/entity/centipede/centipede-head-light-4.png",
                            width_in_frames = 8,
                            height_in_frames = 16,
                        },
                    }
    ...
    local tail_segment_overrides = {
        ...
        animation = meld.overwrite {
            ...
            stripes = {
                {
                    filename = "__tenebris__/graphics/entity/centipede/centipede-tail-1.png",
                    width_in_frames = 5,
                    height_in_frames = 16,
                },
                {
                    filename = "__tenebris__/graphics/entity/centipede/centipede-tail-2.png",
                    width_in_frames = 5,
                    height_in_frames = 16,
                },
                {
                    filename = "__tenebris__/graphics/entity/centipede/centipede-tail-3.png",
                    width_in_frames = 5,
                    height_in_frames = 16,
                },
                {
                    filename = "__tenebris__/graphics/entity/centipede/centipede-tail-4.png",
                    width_in_frames = 5,
                    height_in_frames = 16,
                },
            }
            ...
            layers = {
                {
                    ...
                    stripes = {
                        {
                            filename = "__tenebris__/graphics/entity/centipede/centipede-body-1.png",
                            width_in_frames = 8,
                            height_in_frames = 16,
                        },
                        {
                            filename = "__tenebris__/graphics/entity/centipede/centipede-body-2.png",
                            width_in_frames = 8,
                            height_in_frames = 16,
                        },
                        {
                            filename = "__tenebris__/graphics/entity/centipede/centipede-body-3.png",
                            width_in_frames = 8,
                            height_in_frames = 16,
                        },
                        {
                            filename = "__tenebris__/graphics/entity/centipede/centipede-body-4.png",
                            width_in_frames = 8,
                            height_in_frames = 16,
                        },
                    }
                },
                {
                    ...
                    stripes = {
                        {
                            filename = "__tenebris__/graphics/entity/centipede/centipede-body-light-1.png",
                            width_in_frames = 8,
                            height_in_frames = 16,
                        },
                        {
                            filename = "__tenebris__/graphics/entity/centipede/centipede-body-light-2.png",
                            width_in_frames = 8,
                            height_in_frames = 16,
                        },
                        {
                            filename = "__tenebris__/graphics/entity/centipede/centipede-body-light-3.png",
                            width_in_frames = 8,
                            height_in_frames = 16,
                        },
                        {
                            filename = "__tenebris__/graphics/entity/centipede/centipede-body-light-4.png",
                            width_in_frames = 8,
                            height_in_frames = 16,
                        },
                    }
