...
data:extend({
        ...
        pictures = {
            {
                size = 256,
                scale = 0.2,
                filename = "__tenebris__/graphics/entity/glowdentale/glowdentale-1.png",
                draw_as_glow = true,
            },
            {
                size = 256,
                scale = 0.2,
                filename = "__tenebris__/graphics/entity/glowdentale/glowdentale-2.png",
                draw_as_glow = true,
            },
            {
                size = 256,
                scale = 0.2,
                filename = "__tenebris__/graphics/entity/glowdentale/glowdentale-3.png",
                draw_as_glow = true,
            },
            {
                size = 256,
                scale = 0.2,
                filename = "__tenebris__/graphics/entity/glowdentale/glowdentale-4.png",
                draw_as_glow = true,
            }
        },
    ...
    },
    {
        ...
        pictures = {
            ...
            height = 1024,
            scale = 0.1,
            filename = "__tenebris__/graphics/entity/lucifunnel.png",
            draw_as_glow = true,
        },
    ...
    },
    {
        ...
        pictures = {
            ...
            height = 259,
            scale = 0.1,
            filename = "__tenebris__/graphics/entity/tenecap.png",
        },
