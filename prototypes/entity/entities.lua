...
local bioluminescent_beacon = meld(table.deepcopy(data.raw["beacon"]["beacon"]), {
    ...
    integration_patch = meld.overwrite {
        filename = "__tenebris__/graphics/icons/item-glow.png",
        size = 64,
        scale = 6,
        draw_as_light = true,
    },
        ...
        animation_list = {
            {
                animation = {
                    ...
                    stripes = {
                        {
                            filename = "__tenebris__/graphics/entity/biobeacon.png",
                            width_in_frames = 10,
                            height_in_frames = 1,
                        }
                    }
...
data:extend({
    bioluminescent_beacon,
    {
        type = "furnace",
        name = "bioinfusor",
        icon = "__tenebris__/graphics/icons/bioinfusor.png",
        bioluminescent = true,
        working_sound = {
            sound = { filename = "__tenebris__/sound/bioinfusor.ogg", volume = 0.5 },
        ...
        graphics_set = {
            animation = {
                ...
                stripes = {
                    {
                        filename = "__tenebris__/graphics/entity/bioinfusor.png",
                        width_in_frames = 4,
                        height_in_frames = 4,
                    }
                }
